...
const app_menu = [
    ...
    : []),
  {
    ...
    submenu: [
      {
        label: "About 'Annotation app - Electron'",
        click: () =>
          openAboutWindow({
            icon_path: `${__dirname}/icon.png`,
            product_name: "annotation.saahild.com - Electron",
            package_json_dir: __dirname,
            github_repo: 
            "https://github.com/NeonGamerBot-QK/annotation-app-electon",
            bug_report_url:
              "https://github.com/NeonGamerBot-QK/annotation-app-electon/issues",
...
function createWindow() {
  ...
  win.loadURL(store.get("launchURL") || "https://annotation.saahild.com", {
    userAgent:
...
url.includes("annotation.saahild.com")
      ) {
